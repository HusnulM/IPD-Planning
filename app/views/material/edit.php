                                ...
                                <div role="tabpanel" class="tab-pane fade in active" id="basic_data_view">
                                    ...
                                    <br>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <label for="">Board Quantity</label>
                                                    <input type="number" name="boardqty" id="boardqty" class="form-control" placeholder="Board Quantity" value="<?= $data['material']['board_qty']; ?>" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
